import { askAI, body, json, validateApprovedRfx, validateDecisionReady } from './_lib.js';
...
export default async function handler(req: any, res: any) {
  ...
  try {
    const input = await body(req); validateApprovedRfx(input.rfx); validateDecisionReady(input.comparison);
