# Aerchain business-unit intake - draft 002
...
2. `https://aerchain.io/`, the public Aerchain website, inspected on 2026-09-05.
...
|---|---|---|
| Intake ID | AER-INT-001-DRAFT-002 | Provisional revision of Draft 001 |
...
The public Aerchain website positions Aerchain for procurement teams and describes Aera as an AI procurement assistant. It names intake, sourcing/evaluation, negotiation, onboarding, analytics, and contract capabilities, but it does not identify the specific operating buyer, workflow owner, or current-state process for this assignment. [AER-SRC-006]
...
Draft 002 adds only the public website as a permitted source. Draft 001 remains preserved unchanged. No repository implementation, prior Aerchain documentation, or previous PM decision has been used to fill this intake.
