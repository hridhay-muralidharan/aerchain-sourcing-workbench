...
const sourceFile = "AERCHAIN_BUSINESS_UNIT_INTAKE_DRAFT_001.md";
...
</style></head><body><main class="shell"><header class="masthead"><p class="kicker">Aerchain · discovery input</p><h1>Business-unit intake, first pass.</h1><p class="lede">A provisional reading of the assignment brief, with every evidence gap left visible for your correction before product decisions begin.</p></header><div class="status"><span class="badge"><strong>Version</strong> draft 001</span><span class="badge"><strong>Source</strong> assignment brief + website</span><span class="badge"><strong>Next gate</strong> your review</span><span class="badge"><strong>Downstream</strong> paused</span></div><div class="review-note"><strong>Review focus</strong>Please correct the filled actor, job, workflow, friction, and consequence entries before any additional source is introduced.</div><article class="body">${body}</article><footer class="footer"><span>Source Markdown: <a href="${sourceFile}">${sourceFile}</a></span><span>Generated as a standalone local review page.</span></footer></main></body></html>`;
